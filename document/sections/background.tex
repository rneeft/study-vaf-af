...
\begingroup
\captionsetup{type=figure}
\includegraphics[scale=0.5]{pics/testar-test-cycle.png}
...
\begingroup
\captionsetup{type=figure}
\includegraphics[scale=0.9]{pics/merkle-tree-example.png}
